...
class OpenAIInference:
    def __init__(
        ...
        self.rate_limit = 10000  # requests per minute
        self.request_times = []
    ...
    def setup_logging(self):
        ...
        return logging.getLogger("OpenAIInference")
    ...
    def run_inference(self, posts):
        for post in tqdm(posts, desc="OpenAI Inference", unit="posts"):
            try:
...
def main():
    ...
    parser.add_argument("--api_key_file", type=Path, required=True)
